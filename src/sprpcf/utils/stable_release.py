    ...
    *,
    ...
    return {
        ...
        "scientific_boundary": (
            ...
            "remaining finalization blocker is the prerelease version itself. The promotion action does not create a Git "
            "tag, GitHub Release, DOI, or publication record. Finalization should be rebuilt after promotion before tagging."
        ),
    }
...
def apply_stable_version(plan: dict[str, Any], *, repo_root: str | Path) -> dict[str, Any]:
    ...
    certificate = {
        ...
        "qualification_statement": (
            ...
            "readiness, and paper-results readiness checks passed. Finalization must be rebuilt at the stable version "
